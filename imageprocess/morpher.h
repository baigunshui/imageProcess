...
public:
    ...
    Mat rightImage;
    Mat leftImageTmp;
    Mat rightImageTmp; //显示相关。画线的颜色、线宽、偏移
    Scalar color = Scalar(0, 255, 0);
    int thickness = 2; int shift = 0;
    //按键值，用于控制
    int key;
...
public:
    ...
    void runWarp();
    void main();
    void morphingRun(QString first_image_name, QString second_image_name);
};
